...
import {updateEmployeeNotes} from "../Actions/profile";
import { connect } from 'react-redux';
import "../Client/styles/cn.css";;

class EmployeeAddNote extends Component {
  state={
    description:"",
    type:"purple"
  }
  ...
  submitHandler = e =>{
    ...
    if(inputvalidated(this.state)){
        this.props.updateEmployeeNotes(this.state, this.props.profile[0].id)
        this.setState({
          description:"",
          type:"purple"
        })
...
export default connect(mapStateToProps,{updateEmployeeNotes})(EmployeeAddNote);
